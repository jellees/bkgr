...
const Script script_80B268C = {
    ...
    WaitForCond(SCRIPT_WAIT_COND_ACTOR_NOT_MOVING, 0)
    PlayBillDrillSfx
    ActorMove(1, 120, 80, FX32_CONST(3))
    WaitForCond(SCRIPT_WAIT_COND_ACTOR_NOT_MOVING, 1)
    ActorMove(1, 120, 72, FX32_CONST(3))
    WaitForCond(SCRIPT_WAIT_COND_ACTOR_NOT_MOVING, 1)
    ActorMove(1, 120, 80, FX32_CONST(3))
    WaitForCond(SCRIPT_WAIT_COND_ACTOR_NOT_MOVING, 1)
    ActorMove(1, 120, 76, FX32_CONST(3))
    WaitForCond(SCRIPT_WAIT_COND_ACTOR_NOT_MOVING, 1)
    ActorMove(1, 120, 80, FX32_CONST(3))
    WaitForCond(SCRIPT_WAIT_COND_ACTOR_NOT_MOVING, 1)
    StopBillDrillSfx
    ...
    PlaySfx(19, FALSE)
    PlaySfx(43, FALSE)
    ActorMove(1, 120, -30, FX32_CONST(3))
...
const Script script_80B33C0 = {
    ...
    ActorMove(0, 444, 137, FX32_CONST(1))
    SetWaitFrames(25)
    WaitForCond(SCRIPT_WAIT_COND_FRAMES, 0)
    ActorUnlockAnim(0)
    ActorMove(0, 444, 139, FX32_CONST(1))
    SetWaitFrames(70)
    WaitForCond(SCRIPT_WAIT_COND_FRAMES, 0)
    ...
    ActorMove(0, 444, 136, FX32_CONST(1))
    SetWaitFrames(50)
    WaitForCond(SCRIPT_WAIT_COND_FRAMES, 0)
    ActorUnlockAnim(0)
    ActorMove(0, 444, 140, FX32_CONST(1))
    SetWaitFrames(85)
    WaitForCond(SCRIPT_WAIT_COND_FRAMES, 0)
    Sub805F7D8(279)
    WaitForCond(SCRIPT_WAIT_COND_NOT_IN_DIALOGUE, 0)
    ...
    ActorDoNotSnap(1, FALSE)
    ActorSetDirection(0, DIRECTION_RIGHT)
    ActorMove(0, 474, 141, FX32_CONST(1))
    WaitForCond(SCRIPT_WAIT_COND_ACTOR_NOT_MOVING, 0)
    ActorSetDirection(0, DIRECTION_DOWN)
    ActorMove(0, 486, 196, FX32_CONST(1))
    WaitForCond(SCRIPT_WAIT_COND_ACTOR_NOT_MOVING, 0)
    ActorSetDirection(0, DIRECTION_RIGHT)
    ActorMove(0, 590, 202, FX32_CONST(1))
    WaitForCond(SCRIPT_WAIT_COND_ACTOR_NOT_MOVING, 0)
    ActorDoNotSnap(0, FALSE)
    PlaySfx(60, FALSE)
    SetWaitFrames(5)
    WaitForCond(SCRIPT_WAIT_COND_FRAMES, 0)
    Sub805FB80
    ...
    CameraMove(408, 80, FX32_CONST(1))
    ActorInit(1)
    ...
    CameraMove(424, 176, FX32_CONST(1))
    WaitForCond(SCRIPT_WAIT_COND_CAMERA_NOT_MOVING, 0)
    ActorInit(2)
    ...
    ActorSetAnim(0, 814, 0)
    ActorSetDirection(0, DIRECTION_DOWN)
    ActorMove(0, 535, 242, FX32_CONST(1))
    WaitForCond(SCRIPT_WAIT_COND_ACTOR_NOT_MOVING, 0)
    ActorSetDirection(0, DIRECTION_LEFT)
    ActorMove(0, 495, 242, FX32_CONST(1))
    WaitForCond(SCRIPT_WAIT_COND_ACTOR_NOT_MOVING, 0)
    ...
    StopSfx
    ActorSetDirection(0, DIRECTION_LEFT)
    ActorMove(0, 368, 179, FX32_CONST(1))
    WaitForCond(SCRIPT_WAIT_COND_ACTOR_NOT_MOVING, 0)
    ActorSetDirection(0, DIRECTION_UP)
    ActorMove(0, 368, 139, FX32_CONST(1))
    WaitForCond(SCRIPT_WAIT_COND_ACTOR_NOT_MOVING, 0)
    ActorSetAnim(0, 822, 0)
    ActorSetDirection(0, DIRECTION_RIGHT)
    ActorDoNotSnap(0, FALSE)
    ...
    ActorMove(2, 444, -5, FX32_CONST(3))
    ActorSetAnim(0, 814, 0)
    ActorMove(0, 444, 139, FX32_CONST(1))
    WaitForCond(SCRIPT_WAIT_COND_ACTOR_NOT_MOVING, 0)
    ActorSetAnim(0, 822, 0)
    ...
    PlaySfx(179, TRUE)
    ActorEnable(5)
    CameraMove(120, 84, FX32_CONST(1))
    WaitForCond(SCRIPT_WAIT_COND_CAMERA_NOT_MOVING, 0)
    SetWaitFrames(20)
    WaitForCond(SCRIPT_WAIT_COND_FRAMES, 0)
    ...
    CameraMove(162, 135, FX32_CONST(1))
...
const Script script_80B6160 = {
    ...
    WaitForCond(SCRIPT_WAIT_COND_CAMERA_NOT_MOVING, 0)
    CameraMove(192, 358, FX32_CONST(3))
    WaitForCond(SCRIPT_WAIT_COND_CAMERA_NOT_MOVING, 0)
    Jump(21, 0)
};
...
const Script script_80B6598 = {
    ...
    WaitForCond(SCRIPT_WAIT_COND_FRAMES, 0)
    CameraAlloc
    CameraMove(1218, 32, FX32_CONST(3))
    WaitForCond(SCRIPT_WAIT_COND_CAMERA_NOT_MOVING, 0)
    CameraFree
    LoadRoom(1, 1, 0, 0)
    HidePlayer(TRUE)
...
const Script script_80B6818 = {
    ...
    WaitForCond(SCRIPT_WAIT_COND_FRAMES, 0)
    CameraAlloc
    CameraMove(233, 45, FX32_CONST(3))
    WaitForCond(SCRIPT_WAIT_COND_CAMERA_NOT_MOVING, 0)
    CameraFree
    LoadRoom(1, 11, 0, 0)
    HidePlayer(TRUE)
...
const Script script_80B6A98 = {
    ...
    HidePlayer(TRUE)
    CameraAlloc
    CameraMove(1005, 136, FX32_CONST(3))
    WaitForCond(SCRIPT_WAIT_COND_CAMERA_NOT_MOVING, 0)
    CameraMove(702, 31, FX32_CONST(3))
    WaitForCond(SCRIPT_WAIT_COND_CAMERA_NOT_MOVING, 0)
    CameraFree
    LoadRoom(2, 2, 0, 0)
    HidePlayer(TRUE)
...
const Script script_80B7060 = {
    ...
    CameraMove(1005, 136, FX32_CONST(3))
    WaitForCond(SCRIPT_WAIT_COND_CAMERA_NOT_MOVING, 0)
    CameraMove(360, 27, FX32_CONST(3))
    WaitForCond(SCRIPT_WAIT_COND_CAMERA_NOT_MOVING, 0)
    CameraFree
    LoadRoom(2, 0, 0, 0)
    HidePlayer(TRUE)
...
const Script script_80B7344 = {
    ...
    WaitForCond(SCRIPT_WAIT_COND_ACTOR_NOT_MOVING, 0)
    ActorMove(0, 256, 280, FX32_CONST(3))
    WaitForCond(SCRIPT_WAIT_COND_ACTOR_NOT_MOVING, 0)
    SetBgmVolume(0, TRUE)
    End
};
...
const Script script_80B7588 = {
    ...
    SetWaitFrames(40)
    WaitForCond(SCRIPT_WAIT_COND_FRAMES, 0)
    CameraMove(128, 136, FX32_CONST(2))
    WaitForCond(SCRIPT_WAIT_COND_CAMERA_NOT_MOVING, 0)
    SetWaitFrames(45)
    WaitForCond(SCRIPT_WAIT_COND_FRAMES, 0)
    CameraReturnPrescene(FX32_CONST(1.5))
...
const Script script_80B7D80 = {
    ...
    SetWaitFrames(30)
    WaitForCond(SCRIPT_WAIT_COND_FRAMES, 0)
    ActorMove(0, 256, 490, FX32_CONST(1))
    ActorMove(1, 256, 490, FX32_CONST(1))
    SetWaitFrames(30)
    WaitForCond(SCRIPT_WAIT_COND_FRAMES, 0)
    ActorEnable(0)
    WaitForCond(SCRIPT_WAIT_COND_CAMERA_NOT_MOVING, 0)
...
const Script script_80B8078 = {
    ...
    ActorSetAnim(0, 814, 0)
    ActorMove(0, 256, 535, FX32_CONST(1))
    ActorMove(1, 256, 535, FX32_CONST(1))
    ActorRotateToTarget(0)
    WaitForCond(SCRIPT_WAIT_COND_ACTOR_NOT_MOVING, 0)
    WaitForCond(SCRIPT_WAIT_COND_CAMERA_NOT_MOVING, 0)
    ActorSetPriority(0, 1)
    ActorSetPriority(1, 1)
    ActorMove(0, 256, 615, FX32_CONST(1))
    ActorMove(1, 256, 615, FX32_CONST(1))
    ActorSetDirection(0, DIRECTION_DOWN)
    CameraMove(256, 336, FX32_CONST(2))
    WaitForCond(SCRIPT_WAIT_COND_CAMERA_NOT_MOVING, 0)
    SetWaitFrames(30)
    WaitForCond(SCRIPT_WAIT_COND_FRAMES, 0)
    ActorDisable(2)
...
const Script script_80B84B0 = {
    ...
    ActorSetDirection(2, DIRECTION_LEFT)
    ActorMove(2, 216, 450, FX32_CONST(1))
    ActorMove(3, 216, 450, FX32_CONST(1))
    WaitForCond(SCRIPT_WAIT_COND_ACTOR_NOT_MOVING, 2)
    ActorSetDirection(2, DIRECTION_DOWN)
    ActorMove(2, 216, 523, FX32_CONST(1))
    ActorMove(3, 216, 523, FX32_CONST(1))
    WaitForCond(SCRIPT_WAIT_COND_ACTOR_NOT_MOVING, 2)
    ActorSetDirection(2, DIRECTION_RIGHT)
    ActorMove(2, 256, 523, FX32_CONST(1))
    ActorMove(3, 256, 523, FX32_CONST(1))
    WaitForCond(SCRIPT_WAIT_COND_ACTOR_NOT_MOVING, 2)
    ActorSetAnim(2, 822, 0)
    ActorSetDirection(2, DIRECTION_UP)
    WaitForCond(SCRIPT_WAIT_COND_NOT_IN_DIALOGUE, 0)
    ActorAlwaysVisible(2, FALSE)
    ActorSetAnim(2, 814, 0)
    ActorSetDirection(2, DIRECTION_DOWN)
    ActorMove(2, 256, 590, FX32_CONST(1))
    ActorMove(3, 256, 590, FX32_CONST(1))
    CameraReturnPrescene(FX32_CONST(0))
    WaitForCond(SCRIPT_WAIT_COND_CAMERA_NOT_MOVING, 0)
    ActorAlwaysVisible(0, FALSE)
    CameraFree
    End
};
...
const Script script_80B89EC = {
    ...
    ActorMove(0, 256, 0, FX32_CONST(2))
    SetWaitFrames(90)
    WaitForCond(SCRIPT_WAIT_COND_FRAMES, 0)
    StopSfx
    CameraAlloc
...
const Script script_80B8D48 = {
    ...
    ActorDisable(1)
    CameraAlloc
    CameraMove(768, 245, FX32_CONST(2))
    WaitForCond(SCRIPT_WAIT_COND_CAMERA_NOT_MOVING, 0)
    ActorEnable(0)
    ActorEnable(1)
    ActorDoNotSnap(0, TRUE)
...
const Script script_80B9798 = {
    ...
    ActorSetAffine(0, 0, 464)
    ActorSetMatrixIdx(1, 1)
    ActorSetAffine(1, 0, 256)
    ActorSetMatrixIdx(3, 2)
    ActorSetAffine(3, 0, 256)
    SetWaitFrames(1)
    WaitForCond(SCRIPT_WAIT_COND_FRAMES, 0)
    Sub805F120(0)
    Sub8060C78
    ...
    PlaySfx(220, TRUE)
    Sub805FB80
    ActorStartScaling(0, 256, FX32_CONST(1.75))
    WaitForCond(SCRIPT_WAIT_COND_ACTOR_SCALING_DONE, 0)
    Sub805FBA4
    WaitForCond(SCRIPT_WAIT_COND_8, 0)
    StopSfx
    ActorStartScaling(0, 1024, FX32_CONST(0.5))
    ActorStartRotation(0, 900, FX32_CONST(1), TRUE)
    CameraMove(708, 129, FX32_CONST(3))
    PlaySfx(134, FALSE)
    ...
    ActorStartRotation(0, 192, FX32_CONST(3), TRUE)
    PlaySfx(134, FALSE)
    ActorMove(0, 910, 80, FX32_CONST(6))
    WaitForCond(SCRIPT_WAIT_COND_ACTOR_NOT_MOVING, 0)
    ActorStartRotation(0, 64, FX32_CONST(3), FALSE)
    PlaySfx(134, FALSE)
    ...
    WaitForCond(SCRIPT_WAIT_COND_ACTOR_NOT_MOVING, 0)
    ActorStartRotation(0, 32, FX32_CONST(3), FALSE)
    PlaySfx(134, FALSE)
    ActorMove(0, 700, 571, FX32_CONST(3))
    WaitForCond(SCRIPT_WAIT_COND_ACTOR_NOT_MOVING, 0)
    PlaySfx(185, FALSE)
    ActorSetAnim(0, 702, 1)
    ActorSetAffine(0, 0, 256)
    WaitForCond(SCRIPT_WAIT_COND_ACTOR_ANIM_DONE, 0)
    ActorSetAnim(0, 1259, 0)
    ActorDisable(0)
    WaitForCond(SCRIPT_WAIT_COND_CAMERA_NOT_MOVING, 0)
    ...
    PlaySfx(142, FALSE)
    ActorDoNotSnap(0, TRUE)
    ActorSetAffine(0, 0, 448)
    ActorMove(0, 768, 127, FX32_CONST(6))
    SetWaitFrames(10)
    WaitForCond(SCRIPT_WAIT_COND_FRAMES, 0)
    ActorSetAffine(0, 128, 464)
    SetWaitFrames(10)
    WaitForCond(SCRIPT_WAIT_COND_FRAMES, 0)
    ActorSetAffine(0, 128, 496)
    SetWaitFrames(10)
    WaitForCond(SCRIPT_WAIT_COND_FRAMES, 0)
    ActorSetAffine(0, 0, 528)
    SetWaitFrames(6)
    WaitForCond(SCRIPT_WAIT_COND_FRAMES, 0)
    ActorSetAffine(0, 0, 640)
    SetWaitFrames(6)
    WaitForCond(SCRIPT_WAIT_COND_FRAMES, 0)
    ActorSetAffine(0, 128, 768)
    SetWaitFrames(5)
    WaitForCond(SCRIPT_WAIT_COND_FRAMES, 0)
    ActorSetAffine(0, 128, 1024)
    SetWaitFrames(5)
    WaitForCond(SCRIPT_WAIT_COND_FRAMES, 0)
    ActorSetAffine(0, 0, 1152)
    SetWaitFrames(4)
    WaitForCond(SCRIPT_WAIT_COND_FRAMES, 0)
    ActorSetAffine(0, 0, 1280)
    SetWaitFrames(4)
    WaitForCond(SCRIPT_WAIT_COND_FRAMES, 0)
    ActorSetAffine(0, 128, 1408)
    SetWaitFrames(7)
    WaitForCond(SCRIPT_WAIT_COND_FRAMES, 0)
    ActorSetAffine(0, 0, 1536)
    SetWaitFrames(6)
    WaitForCond(SCRIPT_WAIT_COND_FRAMES, 0)
    ActorSetAffine(0, 128, 1664)
    SetWaitFrames(5)
    WaitForCond(SCRIPT_WAIT_COND_FRAMES, 0)
    ActorSetAffine(0, 0, 1792)
    SetWaitFrames(4)
    WaitForCond(SCRIPT_WAIT_COND_FRAMES, 0)
    ActorSetAffine(0, 128, 1920)
    SetWaitFrames(3)
    WaitForCond(SCRIPT_WAIT_COND_FRAMES, 0)
    ActorSetAffine(0, 0, 2048)
    SetWaitFrames(2)
    WaitForCond(SCRIPT_WAIT_COND_FRAMES, 0)
    ActorSetAffine(0, 128, 2176)
    SetWaitFrames(30)
    WaitForCond(SCRIPT_WAIT_COND_FRAMES, 0)
    ActorSetAnim(0, 1215, 0)
    ActorSetAffine(0, 0, 1024)
    ActorStartRotation(0, 255, FX32_CONST(1), FALSE)
    ActorStartScaling(0, 256, FX32_CONST(16))
    WaitForCond(SCRIPT_WAIT_COND_ACTOR_SCALING_DONE, 0)
    ActorStartScaling(0, 1024, FX32_CONST(12))
    WaitForCond(SCRIPT_WAIT_COND_ACTOR_SCALING_DONE, 0)
    ActorDisable(0)
    CameraReturnPrescene(FX32_CONST(0))
    WaitForCond(SCRIPT_WAIT_COND_CAMERA_NOT_MOVING, 0)
    ...
    ActorLockAnimOnFrame(2, 0)
    PlaySfx(142, FALSE)
    ActorMove(0, 444, 125, FX32_CONST(2))
    WaitForCond(SCRIPT_WAIT_COND_ACTOR_NOT_MOVING, 0)
    SetWaitFrames(20)
    WaitForCond(SCRIPT_WAIT_COND_FRAMES, 0)
    PlaySfx(27, FALSE)
    ...
    ActorMove(1, 480, 192, FX32_CONST(1))
    ActorMove(2, 480, 192, FX32_CONST(1))
    WaitForCond(SCRIPT_WAIT_COND_ACTOR_NOT_MOVING, 1)
    ActorSetDirection(1, DIRECTION_UP)
    ActorMove(1, 480, 139, FX32_CONST(1))
    ActorMove(2, 480, 139, FX32_CONST(1))
    WaitForCond(SCRIPT_WAIT_COND_ACTOR_NOT_MOVING, 1)
    ActorDoNotSnap(1, FALSE)
    ActorDoNotSnap(2, FALSE)
    ActorSetDirection(1, DIRECTION_LEFT)
    ActorMove(1, 444, 139, FX32_CONST(1))
    ActorMove(2, 444, 139, FX32_CONST(1))
    WaitForCond(SCRIPT_WAIT_COND_ACTOR_NOT_MOVING, 1)
    ActorSetDirection(1, DIRECTION_UP)
    ...
    ActorDoNotSnap(4, TRUE)
    ActorDoNotSnap(5, TRUE)
    ActorEnable(4)
    ActorEnable(5)
    ActorSetDirection(4, DIRECTION_DOWN)
    ...
    ActorDoNotSnap(4, FALSE)
    ActorDoNotSnap(5, FALSE)
...
const Script script_80BBB38 = {
    ...
    Sub805F7D8(400)
    WaitForCond(SCRIPT_WAIT_COND_NOT_IN_DIALOGUE, 0)
    CameraMove(170, 80, FX32_CONST(2))
    ActorSetDirection(0, DIRECTION_UP)
...
const Script script_80BE2FC = {
    ...
    ActorSetObjMode(7, 1)
    PlaySfx(73, FALSE)
    ActorMove(0, 1072, 552, FX32_CONST(1))
    ActorMove(1, 1072, 552, FX32_CONST(1))
    ActorMove(2, 959, 558, FX32_CONST(1))
    ActorMove(3, 959, 558, FX32_CONST(1))
    ActorMove(4, 1105, 569, FX32_CONST(1))
    ActorMove(5, 1105, 569, FX32_CONST(1))
    ActorMove(6, 1028, 582, FX32_CONST(1))
    ActorMove(7, 1028, 582, FX32_CONST(1))
    WaitForCond(SCRIPT_WAIT_COND_ACTOR_NOT_MOVING, 2)
...
const Script script_80BF468 = {
    ...
    ActorSetAnim(0, 814, 0)
    ActorSetDirection(0, DIRECTION_RIGHT)
    ActorMove(0, 1440, 291, FX32_CONST(1))
    ActorMove(1, 1440, 291, FX32_CONST(1))
    CameraMove(1440, 291, FX32_CONST(1))
    WaitForCond(SCRIPT_WAIT_COND_ACTOR_NOT_MOVING, 0)
    ActorSetAnim(0, 822, 0)
    ActorSetDirection(0, DIRECTION_UP)
    SetWaitFrames(40)
    ...
    ActorSetAnim(0, 814, 0)
    ActorSetDirection(0, DIRECTION_LEFT)
    ActorMove(0, 1344, 291, FX32_CONST(1))
    ActorMove(1, 1344, 291, FX32_CONST(1))
    CameraReturnPrescene(FX32_CONST(0))
    WaitForCond(SCRIPT_WAIT_COND_ACTOR_NOT_MOVING, 0)
    ActorSetDirection(0, DIRECTION_DOWN)
    ActorMove(0, 1344, 360, FX32_CONST(1))
    ActorMove(1, 1344, 360, FX32_CONST(1))
    WaitForCond(SCRIPT_WAIT_COND_ACTOR_NOT_MOVING, 0)
    ActorSetAnim(0, 822, 0)
    WaitForCond(SCRIPT_WAIT_COND_CAMERA_NOT_MOVING, 0)
    CameraFree
...
const Script script_80BF83C = {
    ...
    ActorSetAnim(0, 814, 0)
    ActorMove(0, 1343, 415, FX32_CONST(1))
    ActorMove(1, 1343, 415, FX32_CONST(1))
    ActorRotateToTarget(0)
    WaitForCond(SCRIPT_WAIT_COND_ACTOR_NOT_MOVING, 0)
    ActorSetDirection(0, DIRECTION_DOWN)
    ActorSetAnim(0, 822, 0)
    ...
    ActorSetDirection(3, DIRECTION_LEFT)
    ActorMove(3, 20, 345, FX32_CONST(1))
    ActorMove(4, 20, 345, FX32_CONST(1))
    ActorEnable(0)
    ActorEnable(1)
    SetBgmVolume(0, FALSE)
    PlaySfx(73, FALSE)
...
const Script script_80C04E4 = {
    ...
    AllocActors(2)
    CameraAlloc
    CameraMove(1040, 570, FX32_CONST(2))
    WaitForCond(SCRIPT_WAIT_COND_CAMERA_NOT_MOVING, 0)
    SetWaitFrames(20)
    WaitForCond(SCRIPT_WAIT_COND_FRAMES, 0)
    ActorInit(0)
...
const Script script_80C1614 = {
    ...
    ActorSetAnim(2, 814, 0)
    ActorSetDirection(2, DIRECTION_LEFT)
    ActorMove(2, 1160, 1233, FX32_CONST(1))
    ActorMove(3, 1160, 1233, FX32_CONST(1))
    WaitForCond(SCRIPT_WAIT_COND_ACTOR_NOT_MOVING, 2)
    ActorSetDirection(2, DIRECTION_UP)
    ActorMove(2, 1216, 1128, FX32_CONST(1))
    ActorMove(3, 1216, 1128, FX32_CONST(1))
...
const Script script_80C1A74 = {
    ...
    ActorSetAnim(0, 773, 0)
    PlaySfx(135, FALSE)
    ActorMove(0, 1216, 1000, FX32_CONST(2))
    SetWaitFrames(16)
    WaitForCond(SCRIPT_WAIT_COND_FRAMES, 0)
    ActorSetPriority(0, 3)
    Sub805F04C(0, 200)
...
const Script script_80C280C = {
    ...
    ActorMove(0, 622, -10000, FX32_CONST(3))
    SetWaitFrames(40)
    WaitForCond(SCRIPT_WAIT_COND_FRAMES, 0)
    End
};
...
const Script script_80C2B90 = {
    ...
    WaitForCond(SCRIPT_WAIT_COND_ACTOR_NOT_MOVING, 0)
    ActorMove(0, 1456, 432, FX32_CONST(3))
    ActorMove(1, 1528, 496, FX32_CONST(3))
    ActorMove(2, 1456, 568, FX32_CONST(3))
    WaitForCond(SCRIPT_WAIT_COND_ACTOR_NOT_MOVING, 0)
    WaitForCond(SCRIPT_WAIT_COND_CAMERA_NOT_MOVING, 0)
    CameraFree
    End
...
const Script script_80C2ED8 = {
    ...
    WaitForCond(SCRIPT_WAIT_COND_ACTOR_NOT_MOVING, 0)
    ActorMove(0, 1528, 496, FX32_CONST(3))
    ActorMove(1, 1488, 560, FX32_CONST(3))
    WaitForCond(SCRIPT_WAIT_COND_ACTOR_NOT_MOVING, 0)
    WaitForCond(SCRIPT_WAIT_COND_CAMERA_NOT_MOVING, 0)
    CameraFree
    End
...
const Script script_80C3180 = {
    ...
    WaitForCond(SCRIPT_WAIT_COND_ACTOR_NOT_MOVING, 0)
    ActorMove(0, 1482, 522, FX32_CONST(3))
    WaitForCond(SCRIPT_WAIT_COND_ACTOR_NOT_MOVING, 0)
    ActorSetPriority(0, 3)
    ActorDoNotSnap(0, FALSE)
    ActorMove(0, 1472, 592, FX32_CONST(3))
    WaitForCond(SCRIPT_WAIT_COND_ACTOR_NOT_MOVING, 0)
    SetBgmVolume(0, TRUE)
    WaitForCond(SCRIPT_WAIT_COND_CAMERA_NOT_MOVING, 0)
    CameraFree
...
const Script script_80C33C4 = {
    ...
    WaitForCond(SCRIPT_WAIT_COND_ACTOR_NOT_MOVING, 0)
    ActorMove(0, 1184, 240, FX32_CONST(3))
    WaitForCond(SCRIPT_WAIT_COND_ACTOR_NOT_MOVING, 0)
    End
};
...
const Script script_80C3BBC = {
    ...
    ActorMove(0, 1968, 195, FX32_CONST(1))
    ActorMove(1, 1968, 195, FX32_CONST(1))
    ...
    ActorMove(0, 1990, 195, FX32_CONST(1))
    ActorMove(1, 1990, 195, FX32_CONST(1))
    WaitForCond(SCRIPT_WAIT_COND_ACTOR_NOT_MOVING, 0)
    ActorSetObjMode(0, 0)
    ActorSetAnim(1, 0, 1)
    ActorLockAnimOnFrame(1, 0)
    ActorMove(0, 2010, 195, FX32_CONST(1))
    ActorMove(1, 2010, 195, FX32_CONST(1))
    WaitForCond(SCRIPT_WAIT_COND_ACTOR_NOT_MOVING, 0)
    ActorSetObjMode(0, 1)
    ActorSetAnim(1, 1094, 1)
    ActorDoNotSnap(0, FALSE)
    ActorDoNotSnap(1, FALSE)
    ActorMove(0, 2030, 195, FX32_CONST(1))
    ActorMove(1, 2030, 195, FX32_CONST(1))
    WaitForCond(SCRIPT_WAIT_COND_ACTOR_NOT_MOVING, 0)
    ActorSetAnim(0, 822, 0)
    ActorSetDirection(0, DIRECTION_UP)
    ActorSetObjMode(0, 0)
    ...
    WaitForCond(SCRIPT_WAIT_COND_NOT_IN_DIALOGUE, 0)
    ActorSetAnim(0, 814, 0)
    ActorMove(0, 1968, 296, FX32_CONST(1))
    ActorMove(1, 1968, 296, FX32_CONST(1))
    CameraReturnPrescene(FX32_CONST(0))
    WaitForCond(SCRIPT_WAIT_COND_CAMERA_NOT_MOVING, 0)
    CameraFree
    End
...
const Script script_80C4468 = {
    ...
    ActorSetAnim(0, 814, 0)
    ActorMove(0, 1968, 348, FX32_CONST(1))
    ActorMove(1, 1968, 348, FX32_CONST(1))
    ActorRotateToTarget(0)
    WaitForCond(SCRIPT_WAIT_COND_ACTOR_NOT_MOVING, 0)
    ActorSetDirection(0, DIRECTION_DOWN)
    ActorSetAnim(0, 822, 0)
    ...
    ActorMove(3, 1968, 810, FX32_CONST(1))
    ActorMove(4, 1968, 810, FX32_CONST(1))
    ActorEnable(0)
    ActorEnable(1)
    SetBgmVolume(0, FALSE)
    PlaySfx(73, FALSE)
...
const Script script_80C4FF8 = {
    ...
    AllocActors(2)
    CameraAlloc
    CameraMove(160, 96, FX32_CONST(2))
    WaitForCond(SCRIPT_WAIT_COND_CAMERA_NOT_MOVING, 0)
    SetWaitFrames(20)
    WaitForCond(SCRIPT_WAIT_COND_FRAMES, 0)
    ActorInit(0)
...
const Script script_80C5AFC = {
    ...
    ActorDoNotSnap(0, TRUE)
    ActorDoNotSnap(1, TRUE)
    ActorMove(0, 1073, 407, FX32_CONST(1))
    WaitForCond(SCRIPT_WAIT_COND_ACTOR_NOT_MOVING, 0)
    ActorMove(0, 1073, 446, FX32_CONST(1))
    ActorMove(1, 1073, 446, FX32_CONST(1))
    WaitForCond(SCRIPT_WAIT_COND_ACTOR_NOT_MOVING, 0)
    ActorMove(0, 920, 446, FX32_CONST(1))
    WaitForCond(SCRIPT_WAIT_COND_ACTOR_NOT_MOVING, 1)
    ActorMove(1, 920, 446, FX32_CONST(1))
    WaitForCond(SCRIPT_WAIT_COND_ACTOR_NOT_MOVING, 1)
    End
};
...
const Script script_80C5D40 = {
    ...
    WaitForCond(SCRIPT_WAIT_COND_ACTOR_NOT_MOVING, 0)
    ActorMove(0, 407, 930, FX32_CONST(1))
    WaitForCond(SCRIPT_WAIT_COND_ACTOR_NOT_MOVING, 0)
    ActorMove(0, 402, 927, FX32_CONST(1))
    WaitForCond(SCRIPT_WAIT_COND_ACTOR_NOT_MOVING, 0)
    ActorMove(0, 397, 924, FX32_CONST(1))
    WaitForCond(SCRIPT_WAIT_COND_ACTOR_NOT_MOVING, 0)
    ActorDoNotSnap(0, FALSE)
    ActorMove(0, 392, 930, FX32_CONST(1))
    WaitForCond(SCRIPT_WAIT_COND_ACTOR_NOT_MOVING, 0)
    SetWaitFrames(13)
    WaitForCond(SCRIPT_WAIT_COND_FRAMES, 0)
    ActorMove(0, 387, 970, FX32_CONST(3))
    WaitForCond(SCRIPT_WAIT_COND_ACTOR_NOT_MOVING, 0)
    PlaySfx(12, FALSE)
    ActorDisable(0)
    SetWaitFrames(20)
    ...
    ActorMove(0, 375, 835, FX32_CONST(1))
    WaitForCond(SCRIPT_WAIT_COND_ACTOR_NOT_MOVING, 0)
    End
};
...
const Script script_80C5FD4 = {
    ...
    WaitForCond(SCRIPT_WAIT_COND_11, 0)
    WaitForCond(SCRIPT_WAIT_COND_10, 2)
    ActorMove(2, 835, 510, FX32_CONST(1))
    SetWaitFrames(20)
    WaitForCond(SCRIPT_WAIT_COND_FRAMES, 0)
    ActorSetAnim(0, 707, 1)
...
const Script script_80C7E38 = {
    ...
    ActorSetObjMode(1, 1)
    CameraAlloc
    CameraMove(701, 400, FX32_CONST(1))
    WaitForCond(SCRIPT_WAIT_COND_CAMERA_NOT_MOVING, 0)
    ActorMove(0, 816, 443, FX32_CONST(1))
    ActorMove(1, 736, 443, FX32_CONST(1))
    CameraMove(816, 443, FX32_CONST(1))
    WaitForCond(SCRIPT_WAIT_COND_ACTOR_NOT_MOVING, 1)
    ActorDisable(1)
    WaitForCond(SCRIPT_WAIT_COND_ACTOR_NOT_MOVING, 0)
    ActorInit(2)
    ...
    WaitForCond(SCRIPT_WAIT_COND_ACTOR_ANIM_DONE, 2)
    ActorMove(0, 736, 443, FX32_CONST(1))
    ActorSetAnim(2, 550, 0)
    CameraReturnPrescene(FX32_CONST(1.5))
    WaitForCond(SCRIPT_WAIT_COND_ACTOR_NOT_MOVING, 0)
    ActorEnable(1)
    ActorMove(0, 687, 443, FX32_CONST(1))
    ...
    WaitForCond(SCRIPT_WAIT_COND_ACTOR_NOT_MOVING, 0)
    ActorSetPriority(0, 1)
    ActorMove(0, 687, 420, FX32_CONST(1))
    ActorMove(1, 687, 420, FX32_CONST(1))
    WaitForCond(SCRIPT_WAIT_COND_ACTOR_NOT_MOVING, 0)
    ActorDisable(1)
    ActorMove(0, 687, 200, FX32_CONST(1))
    WaitForCond(SCRIPT_WAIT_COND_ACTOR_NOT_MOVING, 0)
    End
};
...
const Script script_80C8F04 = {
    ...
    ActorSetAnim(0, 814, 0)
    ActorSetDirection(0, DIRECTION_DOWN)
    ActorMove(0, 256, 256, FX32_CONST(1))
    ActorMove(1, 256, 256, FX32_CONST(1))
    WaitForCond(SCRIPT_WAIT_COND_ACTOR_NOT_MOVING, 0)
    ActorSetAnim(0, 822, 0)
    WaitForCond(SCRIPT_WAIT_COND_CAMERA_NOT_MOVING, 0)
    CameraFree
...
const Script script_80C9184 = {
    ...
    ActorSetAnim(0, 814, 0)
    ActorMove(0, 256, 328, FX32_CONST(1))
    ActorMove(1, 256, 328, FX32_CONST(1))
    ActorRotateToTarget(0)
    WaitForCond(SCRIPT_WAIT_COND_ACTOR_NOT_MOVING, 0)
    PlaySfx(210, FALSE)
    ActorDisable(1)
    ...
    ActorSetAnim(3, 814, 0)
    ActorSetDirection(3, DIRECTION_DOWN)
    ActorMove(3, 256, 1096, FX32_CONST(1))
    ActorMove(4, 256, 1096, FX32_CONST(1))
    ActorEnable(0)
    ActorEnable(1)
    SetBgmVolume(0, FALSE)
    PlaySfx(73, FALSE)
...
const Script script_80C9B98 = {
    ...
    WaitForCond(SCRIPT_WAIT_COND_10, 0)
    CameraAlloc
    CameraMove(269, 692, FX32_CONST(3))
    WaitForCond(SCRIPT_WAIT_COND_CAMERA_NOT_MOVING, 0)
    SetWaitFrames(15)
    WaitForCond(SCRIPT_WAIT_COND_FRAMES, 0)
    PlaySfx(174, FALSE)
...
const Script script_80CA1D8 = {
    ...
    AllocActors(2)
    CameraAlloc
    CameraMove(403, 471, FX32_CONST(2))
    WaitForCond(SCRIPT_WAIT_COND_CAMERA_NOT_MOVING, 0)
    SetWaitFrames(20)
    WaitForCond(SCRIPT_WAIT_COND_FRAMES, 0)
    ActorInit(0)
...
const Script script_80CA354 = {
    ...
    AllocActors(2)
    CameraAlloc
    CameraMove(256, 288, FX32_CONST(2))
    WaitForCond(SCRIPT_WAIT_COND_CAMERA_NOT_MOVING, 0)
    SetWaitFrames(20)
    WaitForCond(SCRIPT_WAIT_COND_FRAMES, 0)
    ActorInit(0)
