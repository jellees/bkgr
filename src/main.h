...
extern u8 gPrediveRoomIdx;
extern fx32 gPredivePosX;
extern fx32 gPredivePosY;
extern fx32 gPredivePosZ;
...
extern void sub_800B958(fx32 a1, fx32 a2, fx32 a3, fx32 a4, bool32 a5);
extern bool32 sub_0800BCD4(struct struc_44* a1);
extern void load_room_directly(int room, int warp, bool32 setGoal);
extern void sub_800C1E8(int room, fx32 xPos, fx32 yPos, fx32 zPos, int a5, u32 a6);
extern void sub_0800C388(int a1, int a2);
extern int sub_800C50C();
extern void save_predive_position(void);
...
extern void decrease_player_health(int amount);
...
extern void restore_full_health(void);
extern bool32 is_game_complete(void);
