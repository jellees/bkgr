...
void InitMenu(u32 menu, u32 language) {
    ...
    switch (menu) {
        ...
        case 1:
            ...
            SetSprite(&gMenu.spriteBuffer[1], 0x477u, 0, 0, 0, gMenu.xPosition,
                      gMenu.yPosition + gMenu.lineHeight, 2);
            SetSprite(&gMenu.spriteBuffer[2], 0x478u, 0, 0, 0, gMenu.xPosition,
                      2 * gMenu.lineHeight + gMenu.yPosition, 2);
            SetSprite(&gMenu.spriteBuffer[3], 0x479u, 0, 0, 0, gMenu.xPosition,
                      3 * gMenu.lineHeight + gMenu.yPosition, 2);
            switch (language) {
                case 0:
